                    ...
                    <div className="workspace-panel flex flex-col overflow-hidden lg:min-h-0">
                        ...
                        <div className="mt-6 space-y-5">
                            ...
                            <div className="min-w-0">
                                ...
                                <div
                                    className={`hover-scrollbar hover-scrollbar-hint flex min-h-24 w-full min-w-0 max-w-full gap-2 overflow-x-scroll overflow-y-hidden rounded-lg border border-dashed p-2 pb-3 overscroll-x-contain transition-colors ${isReferenceDragActive ? "border-primary bg-primary/5" : "border-stone-300 dark:border-stone-700"}`}
                                    onDragEnter={(event) => {
