...
export type ImageQuickToolId = "info" | "delete" | "saveAsset" | "submitPrompt" | "download" | "edit" | ImageNodeActionToolId;
...
const defaultBaseToolIds: ImageQuickToolId[] = ["info", "delete", "saveAsset", "submitPrompt", "download", "edit"];
