...
export function CanvasZoomControls({ scale, onScaleChange, onReset, isMiniMapOpen, onToggleMiniMap }: CanvasZoomControlsProps) {
    ...
    return (
        <div className="absolute bottom-4 left-4 z-50 lg:bottom-5 lg:left-5" onMouseDown={(event) => event.stopPropagation()} onPointerDown={(event) => event.stopPropagation()}>
            <div className="flex h-12 items-center gap-1 rounded-2xl border px-1.5" style={dockStyle}>
